  ...
  return (
    <>
      ...
      <div className={cn("min-h-screen", bodyFontClass)} style={{ backgroundColor: 'var(--pixel-bg, #FAF8F3)', color: 'var(--pixel-text, #2C2416)', ...variableStyles }}>
        ...
        {/* Footer */}
        <footer className="mt-16 pt-8 pb-8 border-t" style={{ borderColor: 'var(--pixel-primary, #D4AF37)', opacity: 0.2 }}>
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 px-4 md:px-6 lg:px-8">
            ...
            <div className="flex-shrink-0">
              {restaurant.logo_url ? (
                ...
                <span className={cn("text-lg font-bold", headerFontClass)} style={{ color: 'var(--pixel-text, #1e3a2f)' }}>
                  {restaurant.name}
                </span>
              )}
            </div>
            ...
            <div className="flex items-center gap-2 text-xs" style={{ color: 'var(--pixel-text, #1e3a2f)', opacity: 0.7 }}>
