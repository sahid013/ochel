            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 px-4 md:px-6 lg:px-8">
              ...
              <div className="flex-shrink-0">
                {restaurant.logo_url ? (
                  ...
                  <span className={cn("text-lg font-bold", headerFontClass)} style={{ color: 'var(--pixel-text, #1f2937)' }}>
                    {restaurant.name}
                  </span>
                )}
              </div>
              ...
              <div className="flex items-center gap-2 text-xs" style={{ color: 'var(--pixel-text, #1f2937)', opacity: 0.7 }}>
