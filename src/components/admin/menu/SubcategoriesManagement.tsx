  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await onSave({
        ...
        title: title.trim(),
        text: text.trim() || null,
        title_en: subcategory?.title_en || null,
        text_en: subcategory?.text_en || null,
        title_it: subcategory?.title_it || null,
        text_it: subcategory?.text_it || null,
        title_es: subcategory?.title_es || null,
        text_es: subcategory?.text_es || null,
