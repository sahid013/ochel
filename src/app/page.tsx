        ...
        <div className="max-w-[1460px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <AnimateIn animation="slide" delay={300} className="text-center">
              ...
              <h3 className="text-xl font-bold text-primary mb-2 font-plus-jakarta-sans">{t('home.features.fast.title')}</h3>
              <p className="text-secondary font-plus-jakarta-sans">{t('home.features.fast.description')}</p>
            </AnimateIn>
            ...
            <AnimateIn animation="slide" delay={500} className="text-center">
              ...
              <h3 className="text-xl font-bold text-primary mb-2 font-plus-jakarta-sans">{t('home.features.customizable.title')}</h3>
              <p className="text-secondary font-plus-jakarta-sans">{t('home.features.customizable.description')}</p>
            </AnimateIn>
            ...
            <AnimateIn animation="slide" delay={700} className="text-center">
              ...
              <h3 className="text-xl font-bold text-primary mb-2 font-plus-jakarta-sans">{t('home.features.mobile.title')}</h3>
              <p className="text-secondary font-plus-jakarta-sans">{t('home.features.mobile.description')}</p>
            </AnimateIn>
          </div>
        </div>
      </div>
